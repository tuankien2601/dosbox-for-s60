...
// JOCO_TRIM
#define TLB_SIZE		(64*1024)  // was (1024*1024)
...
struct X86_PageEntryBlock{
	...
	Bit32u		wr:1 GCC_ATTRIBUTE(packed);
	Bit32u		us:1 GCC_ATTRIBUTE(packed);
	Bit32u		pwt:1 GCC_ATTRIBUTE(packed);
	Bit32u		pcd:1 GCC_ATTRIBUTE(packed);
	Bit32u		a:1 GCC_ATTRIBUTE(packed);
	Bit32u		d:1 GCC_ATTRIBUTE(packed);
	Bit32u		pat:1 GCC_ATTRIBUTE(packed);
	Bit32u		g:1 GCC_ATTRIBUTE(packed);
	Bit32u		avl:3 GCC_ATTRIBUTE(packed);
	Bit32u		base:20 GCC_ATTRIBUTE(packed);
#endif
