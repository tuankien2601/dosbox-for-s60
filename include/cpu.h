...
struct S_Descriptor {
	...
	Bit32u base_16_23	:8;
#else
	Bit32u limit_0_15	:16 GCC_ATTRIBUTE(packed);
	Bit32u base_0_15	:16 GCC_ATTRIBUTE(packed);
	Bit32u base_16_23	:8 	GCC_ATTRIBUTE(packed);
	Bit32u type			:5 	GCC_ATTRIBUTE(packed);
	Bit32u dpl			:2 	GCC_ATTRIBUTE(packed);
	Bit32u p			:1 	GCC_ATTRIBUTE(packed);
	Bit32u limit_16_19	:4 	GCC_ATTRIBUTE(packed);
	Bit32u avl			:1 	GCC_ATTRIBUTE(packed);
	Bit32u r			:1 	GCC_ATTRIBUTE(packed);
	Bit32u big			:1 	GCC_ATTRIBUTE(packed);
	Bit32u g			:1 	GCC_ATTRIBUTE(packed);
	Bit32u base_24_31	:8 	GCC_ATTRIBUTE(packed);
#endif
...
struct G_Descriptor {
	...
	Bit32u paramcount	:5;
#else
	Bit32u offset_0_15	:16 GCC_ATTRIBUTE(packed);
	Bit32u selector		:16 GCC_ATTRIBUTE(packed);
	Bit32u paramcount	:5 	GCC_ATTRIBUTE(packed);
	Bit32u reserved		:3 	GCC_ATTRIBUTE(packed);
	Bit32u type			:5 	GCC_ATTRIBUTE(packed);
	Bit32u dpl			:2 	GCC_ATTRIBUTE(packed);
	Bit32u p			:1 	GCC_ATTRIBUTE(packed);
	Bit32u offset_16_31	:16 GCC_ATTRIBUTE(packed);
#endif
} GCC_ATTRIBUTE(packed);

struct TSS_16 {	
    Bit16u back GCC_ATTRIBUTE(packed);                 /* Back link to other task */
    Bit16u sp0 GCC_ATTRIBUTE(packed);				     /* The CK stack pointer */
    Bit16u ss0 GCC_ATTRIBUTE(packed);					 /* The CK stack selector */
	Bit16u sp1 GCC_ATTRIBUTE(packed);                  /* The parent KL stack pointer */
    Bit16u ss1 GCC_ATTRIBUTE(packed);                  /* The parent KL stack selector */
	Bit16u sp2 GCC_ATTRIBUTE(packed);                  /* Unused */
    Bit16u ss2 GCC_ATTRIBUTE(packed);                  /* Unused */
    Bit16u ip GCC_ATTRIBUTE(packed);                   /* The instruction pointer */
    Bit16u flags GCC_ATTRIBUTE(packed);                /* The flags */
    Bit16u ax GCC_ATTRIBUTE(packed), cx GCC_ATTRIBUTE(packed), dx GCC_ATTRIBUTE(packed), bx GCC_ATTRIBUTE(packed);       /* The general purpose registers */
    Bit16u sp GCC_ATTRIBUTE(packed), bp GCC_ATTRIBUTE(packed), si GCC_ATTRIBUTE(packed), di GCC_ATTRIBUTE(packed);       /* The special purpose registers */
    Bit16u es GCC_ATTRIBUTE(packed);                   /* The extra selector */
    Bit16u cs GCC_ATTRIBUTE(packed);                   /* The code selector */
    Bit16u ss GCC_ATTRIBUTE(packed);                   /* The application stack selector */
    Bit16u ds GCC_ATTRIBUTE(packed);                   /* The data selector */
    Bit16u ldt GCC_ATTRIBUTE(packed);                  /* The local descriptor table */
} GCC_ATTRIBUTE(packed);

struct TSS_32 {	
    Bit32u back GCC_ATTRIBUTE(packed);                /* Back link to other task */
	Bit32u esp0 GCC_ATTRIBUTE(packed);		         /* The CK stack pointer */
    Bit32u ss0 GCC_ATTRIBUTE(packed);					 /* The CK stack selector */
	Bit32u esp1 GCC_ATTRIBUTE(packed);                 /* The parent KL stack pointer */
    Bit32u ss1 GCC_ATTRIBUTE(packed);                  /* The parent KL stack selector */
	Bit32u esp2 GCC_ATTRIBUTE(packed);                 /* Unused */
    Bit32u ss2 GCC_ATTRIBUTE(packed);                  /* Unused */
	Bit32u cr3 GCC_ATTRIBUTE(packed);                  /* The page directory pointer */
    Bit32u eip GCC_ATTRIBUTE(packed);                  /* The instruction pointer */
    Bit32u eflags GCC_ATTRIBUTE(packed);               /* The flags */
    Bit32u eax GCC_ATTRIBUTE(packed), ecx GCC_ATTRIBUTE(packed), edx GCC_ATTRIBUTE(packed), ebx GCC_ATTRIBUTE(packed);   /* The general purpose registers */
    Bit32u esp GCC_ATTRIBUTE(packed), ebp GCC_ATTRIBUTE(packed), esi GCC_ATTRIBUTE(packed), edi GCC_ATTRIBUTE(packed);   /* The special purpose registers */
    Bit32u es GCC_ATTRIBUTE(packed);                   /* The extra selector */
    Bit32u cs GCC_ATTRIBUTE(packed);                   /* The code selector */
    Bit32u ss GCC_ATTRIBUTE(packed);                   /* The application stack selector */
    Bit32u ds GCC_ATTRIBUTE(packed);                   /* The data selector */
    Bit32u fs GCC_ATTRIBUTE(packed);                   /* And another extra selector */
    Bit32u gs GCC_ATTRIBUTE(packed);                   /* ... and another one */
    Bit32u ldt GCC_ATTRIBUTE(packed);                  /* The local descriptor table */
} GCC_ATTRIBUTE(packed);
