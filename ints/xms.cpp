...
#endif
struct XMS_MemMove{
	Bit32u length GCC_ATTRIBUTE(packed);
	Bit16u src_handle GCC_ATTRIBUTE(packed);
	union {
		RealPt realpt GCC_ATTRIBUTE(packed);
		Bit32u offset GCC_ATTRIBUTE(packed);
	}  GCC_ATTRIBUTE(packed) src GCC_ATTRIBUTE(packed);
	Bit16u dest_handle GCC_ATTRIBUTE(packed);
	union {
		RealPt realpt GCC_ATTRIBUTE(packed);
		Bit32u offset GCC_ATTRIBUTE(packed);
	}  GCC_ATTRIBUTE(packed) dest GCC_ATTRIBUTE(packed);
