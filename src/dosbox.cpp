...
//JOCO_TRIM void GUS_Init(Section*);
//JOCO_TRIM void MPU401_Init(Section*);
void PCSPEAKER_Init(Section*);
//JOCO_TRIM void TANDYSOUND_Init(Section*);
//JOCO_TRIM void DISNEY_Init(Section*);
...
//by JOCO
extern void S60_MouseMove(Bit32u ticks);
...
void DOSBOX_Init(void) {
	...
	secprop->Add_int("memsize",2); //by JOCOwas 16
	...
	// by JOCO changed default from normal2x to none
...
#else
	secprop->Add_string("core","simple");
#endif
...
//JOCO_TRIM 	secprop->AddInitFunction(&TANDYSOUND_Init,true);//done
//JOCO_TRIM 	secprop->Add_string("tandy","auto");
//JOCO_TRIM 	secprop->Add_int("tandyrate",22050);
//JOCO_TRIM 	secprop->AddInitFunction(&DISNEY_Init,true);//done
//JOCO_TRIM 	secprop->Add_bool("disney",true);

	MSG_Add("SPEAKER_CONFIGFILE_HELP",
		"pcspeaker -- Enable PC-Speaker emulation.\n"
		"pcrate -- Sample rate of the PC-Speaker sound generation.\n"
//JOCO_TRIM 		"tandy -- Enable Tandy Sound System emulation (off,on,auto).\n"
//JOCO_TRIM 		"         For auto Tandysound emulation is present only if machine is set to tandy.\n"
//JOCO_TRIM 		"tandyrate -- Sample rate of the Tandy 3-Voice generation.\n"
//JOCO_TRIM 		"disney -- Enable Disney Sound Source emulation. Covox Voice Master and Speech Thing compatible.\n"
	);
