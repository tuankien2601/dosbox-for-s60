...
#endif
struct EXE_Header {
	Bit16u signature GCC_ATTRIBUTE(packed);					/* EXE Signature MZ or ZM */
	Bit16u extrabytes GCC_ATTRIBUTE(packed);					/* Bytes on the last page */
	Bit16u pages GCC_ATTRIBUTE(packed);						/* Pages in file */
	Bit16u relocations GCC_ATTRIBUTE(packed);					/* Relocations in file */
	Bit16u headersize GCC_ATTRIBUTE(packed);					/* Paragraphs in header */
	Bit16u minmemory GCC_ATTRIBUTE(packed);					/* Minimum amount of memory */
	Bit16u maxmemory GCC_ATTRIBUTE(packed);					/* Maximum amount of memory */
	Bit16u initSS GCC_ATTRIBUTE(packed);
	Bit16u initSP GCC_ATTRIBUTE(packed);
	Bit16u checksum GCC_ATTRIBUTE(packed);
	Bit16u initIP GCC_ATTRIBUTE(packed);
	Bit16u initCS GCC_ATTRIBUTE(packed);
	Bit16u reloctable GCC_ATTRIBUTE(packed);
	Bit16u overlay GCC_ATTRIBUTE(packed);
