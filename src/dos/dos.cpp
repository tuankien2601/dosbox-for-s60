...
public:
	DOS(Section* configuration):Module_base(configuration){
		...
		//JOCO_DEBUG_TIME
		dos.date.day=(Bit8u)1;//loctime->tm_mday;
		dos.date.month=(Bit8u)1;//loctime->tm_mon+1;
		dos.date.year=(Bit16u)2010;//loctime->tm_year+1900;
		Bit32u ticks=(Bit32u)0;//((loctime->tm_hour*3600+loctime->tm_min*60+loctime->tm_sec)*18.2);
