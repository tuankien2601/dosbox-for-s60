...
// stub // mov dest_reg, word [FC_SEGS_ADDR + index]
}
...
// stub // mov dest_reg, dword [FC_SEGS_ADDR + index]
}
...
// stub // add dest_reg, dword [FC_SEGS_ADDR + index]
}
...
// stub // mov dest_reg, word [FC_REGS_ADDR + index]
}
...
// stub // mov dest_reg, dword [FC_REGS_ADDR + index]
}
...
// stub // mov dest_reg, byte [FC_REGS_ADDR + index]
}
...
// stub // add dest_reg, dword [FC_REGS_ADDR + index]
}
...
// stub // mov word [FC_REGS_ADDR + index], dest_reg
}
...
// stub // mov dword [FC_REGS_ADDR + index], dest_reg
}
...
// stub // mov byte [FC_REGS_ADDR + index], dest_reg
}
