...
#endif
struct MODE_INFO{
	Bit16u ModeAttributes GCC_ATTRIBUTE(packed);
	Bit8u WinAAttributes GCC_ATTRIBUTE(packed);
	Bit8u WinBAttributes GCC_ATTRIBUTE(packed);
	Bit16u WinGranularity GCC_ATTRIBUTE(packed);
	Bit16u WinSize GCC_ATTRIBUTE(packed);
	Bit16u WinASegment GCC_ATTRIBUTE(packed);
	Bit16u WinBSegment GCC_ATTRIBUTE(packed);
	Bit32u WinFuncPtr GCC_ATTRIBUTE(packed);
	Bit16u BytesPerScanLine GCC_ATTRIBUTE(packed);
	Bit16u XResolution GCC_ATTRIBUTE(packed);
	Bit16u YResolution GCC_ATTRIBUTE(packed);
	Bit8u XCharSize GCC_ATTRIBUTE(packed);
	Bit8u YCharSize GCC_ATTRIBUTE(packed);
	Bit8u NumberOfPlanes GCC_ATTRIBUTE(packed);
	Bit8u BitsPerPixel GCC_ATTRIBUTE(packed);
	Bit8u NumberOfBanks GCC_ATTRIBUTE(packed);
	Bit8u MemoryModel GCC_ATTRIBUTE(packed);
	Bit8u BankSize GCC_ATTRIBUTE(packed);
	Bit8u NumberOfImagePages GCC_ATTRIBUTE(packed);
	Bit8u Reserved_page GCC_ATTRIBUTE(packed);
	Bit8u RedMaskSize GCC_ATTRIBUTE(packed);
	Bit8u RedMaskPos GCC_ATTRIBUTE(packed);
	Bit8u GreenMaskSize GCC_ATTRIBUTE(packed);
	Bit8u GreenMaskPos GCC_ATTRIBUTE(packed);
	Bit8u BlueMaskSize GCC_ATTRIBUTE(packed);
	Bit8u BlueMaskPos GCC_ATTRIBUTE(packed);
	Bit8u ReservedMaskSize GCC_ATTRIBUTE(packed);
	Bit8u ReservedMaskPos GCC_ATTRIBUTE(packed);
	Bit8u DirectColorModeInfo GCC_ATTRIBUTE(packed);
	Bit32u PhysBasePtr GCC_ATTRIBUTE(packed);
	Bit32u OffScreenMemOffset GCC_ATTRIBUTE(packed);
	Bit16u OffScreenMemSize GCC_ATTRIBUTE(packed);
	Bit8u Reserved[206] GCC_ATTRIBUTE(packed);
